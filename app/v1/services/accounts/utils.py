...
def send_mail(subject, bodymessage, from_addr, to_addr):
    ...
    '<p><img src="cid:0"></p>' + bodymessage +
    '</body></html>', 'html', 'utf-8'))

    server = smtplib.SMTP('smtp.mailgun.org', 587)
    server.set_debuglevel(1)
    server.login('postmaster@sandboxc316f4780cb14a5d9fcc134593de8d0e.mailgun.org', 'c2ef9814b21d88a80681ace5d2b0a522-73e57fef-d7834906')
    server.sendmail('leandroturdera1982@gmail.com', to_addr, msg.as_string())
    server.quit()
    
if __name__ == "__main__":
    send_mail('Account_summary','Account_summary','leandroturdera1982@gmail.com','leandro.g.bedrinan@gmail.com')
